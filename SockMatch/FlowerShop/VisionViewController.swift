...
class VisionViewController: ViewController {
    ...
    fileprivate func showProductInfo(_ identifier: String) {
        ...
        DispatchQueue.main.async(execute: {
            if self.productViewOpen || self.presentedViewController != nil {
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "SockImageClassification", withExtension: "mlmodelc") else {
            print("no model")
